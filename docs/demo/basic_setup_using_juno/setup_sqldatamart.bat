...
:: oc host name
set foreign_server_host_name=localhost
:: oc host ip address
set foreign_server_host_address=127.0.0.1
:: oc port
set foreign_server_port=5446
:: oc database name
set foreign_server_database=openclinica
:: oc foreign server connection user
set foreign_server_user_name=postgres
:: oc foreign server connection user password
set foreign_server_user_password=password
