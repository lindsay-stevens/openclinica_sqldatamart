CREATE VIEW dm.discrepancy_notes_all AS
  SELECT
  ...
  FROM
    (
      SELECT
        ...
        dn.date_created,
        CASE
        WHEN dn.discrepancy_note_type_id = 1
          THEN $$Failed Validation Check$$ :: TEXT
        WHEN dn.discrepancy_note_type_id = 2
          THEN $$Annotation$$ :: TEXT
        WHEN dn.discrepancy_note_type_id = 3
          THEN $$Query$$ :: TEXT
        WHEN dn.discrepancy_note_type_id = 4
          THEN $$Reason for Change$$ :: TEXT
        ELSE $$unhandled$$ :: TEXT
      ...
      (
        (
          (
            (
              SELECT
                ...
                cd.item_description
              FROM openclinica_fdw.dn_item_data_map AS didm
              JOIN dm.clinicaldata AS cd
              ...
              FROM openclinica_fdw.dn_event_crf_map AS decm
            ...
            SELECT
              ...
              NULL :: TEXT AS crf_section_label,
              NULL :: TEXT AS item_description
            FROM openclinica_fdw.dn_study_event_map AS dsem
            JOIN
          ...
          SELECT
            ...
            NULL :: TEXT AS crf_section_label,
            NULL :: TEXT AS item_description
          FROM openclinica_fdw.dn_study_subject_map AS dssm
          JOIN dm.clinicaldata AS cd
        ...
        SELECT
          ...
          NULL :: TEXT AS crf_section_label,
          NULL :: TEXT AS item_description
        FROM openclinica_fdw.dn_subject_map AS dsm
        JOIN dm.clinicaldata AS cd
